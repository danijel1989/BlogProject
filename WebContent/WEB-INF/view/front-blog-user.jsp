          ...
          <div class="container">
            <h2 class="mb-3 author d-flex align-items-center flex-wrap">
              <div class="avatar"><img src="img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
                <span> Blogs by author - "${user}"</span>
              </div>
            </h2>
            <div class="row">
              <!-- post -->
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    ...
                    <div class="category"><a href="/BlogProject/front-blog-category/${blog.category.seoName}/${blog.category.id}">${blog.category.name}</a></div>
