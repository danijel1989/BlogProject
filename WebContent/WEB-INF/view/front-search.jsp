          ...
          <div class="container">
            ...
            <c:forEach var="blog" items="${blogs}">
	              ...
	              <div class="post col-xl-6">
	                <div class="post-thumbnail"><a href="front-blog-details?id=${blog.id}"><img src="${blog.image}" alt="..." class="img-fluid"></a></div>
	                <div class="post-details">
	                  <div class="post-meta d-flex justify-content-between">
	                    <div class="date meta-last">${blog.dateFormatted}</div>
	                    <div class="category"><a href="front-blog-category?category=${blog.category.id}">${blog.category.name}</a></div>
	                  </div><a href="front-blog-details?id=${blog.id}">
